...
export default function TypewriterTitle({
    sequences = [
        { text: "Fixes", deleteAfter: true },
        { text: "Features", deleteAfter: true },
        { text: "Boosts", deleteAfter: true },
        { text: "Tweaks", deleteAfter: true },
        { text: "Upgrades", deleteAfter: true },
        { text: "Updates", deleteAfter: true },
        { text: "Support", deleteAfter: true },
        { text: "Live changes", deleteAfter: false },
    ],
    typingSpeed = 100,
    startDelay = 500,
    autoLoop = true,

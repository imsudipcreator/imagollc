...
export function LogoCarousel({ columns = 2 }: { columns?: number }) {
    ...
    const logos = useMemo<Logo[]>(
        () => [
            { id: 1, name: "Dub", src: "/assets/home/icons/dub.svg" },
            { id: 2, name: "Supabase", src: "/assets/home/icons/supabase.svg" },
            { id: 3, name: "Vercel", src: "/assets/home/icons/vercel.svg" },
            { id: 4, name: "Resend", src: "/assets/home/icons/resend.svg" },
            { id: 5, name: "Shadcn", src: "/assets/home/icons/shadcn.svg" },
        ],
        []
    );
    ...
    const distributeLogos = useCallback(
        (logos: Logo[]) => {
            ...
            shuffled.forEach((logo, index) => {
                result[index % columns]?.push(logo); // error here which you already know
            });

...
const IntelligencePage = () => {
  return (
    <main className="w-full min-h-screen bg-white flex flex-col items-center justify-start gap-4">
      ...
      <section className='bg-[#f5f5f7] text-black/60 mt-20 pt-7 w-full flex items-center justify-center'>
...
function Blocks() {
  return (
    <section className='w-full min-h-screen flex flex-row flex-wrap items-center justify-between gap-5'>
      {

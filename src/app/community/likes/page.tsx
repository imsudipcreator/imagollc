...
const LikesPage = () => {
  ...
  const { data, isPending, isFetchingNextPage, hasNextPage, fetchNextPage } = api.communityPost.getLikedPosts.useInfiniteQuery(
    { limit: 6 },
  ...
  return (
    <div className='h-fit min-h-svh w-full flex flex-col items-center justify-start overflow-y-auto px-4 gap-2 pb-24'>
      <nav className='w-full h-14 flex items-center justify-between shrink-0'>
        <h1 className='font-semibold text-lg'>My Likes</h1>
